# Brand Visibility Worker Template
...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/brand-visibility-worker-template)
...
```bash
git clone https://github.com/cloudflare/brand-visibility-worker-template
cd brand-visibility-worker-template
npm install
