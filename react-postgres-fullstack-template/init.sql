...
(10, 'A Tale of Two Cities', 'Charles Dickens', 'A Tale of Two Cities is a historical novel published in 1859 by English author Charles Dickens, set in London and Paris before and during the French Revolution.', '/images/books/a-tale-of-two-cities.jpg', 'Want to read')
