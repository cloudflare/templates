/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4695aef3b1b47fdeac073cd813b8e230)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		API_TOKEN: string;
		DB: D1Database;
		CUSTOMER_WORKFLOW: Workflow<Parameters<import("./dist/index").CustomerWorkflow['run']>[0]['payload']>;
	}
}
